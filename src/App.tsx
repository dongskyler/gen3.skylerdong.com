      ...
      <div className="App">
        <header className="App-header">
          ...
          <p>
            ...
            website, with React, Sass, Node, Express, MongoDB and TypeScript.
          </p>
          <p>
            I just finished setting up my server (VPS). It runs on CentOS 8 and
            Nginx.
          </p>
        </header>
        <body>
          <div>
            ...
            >
              <h3>Visit the 2nd generation of my website</h3>
            </a>
            <p>
          ...
          <div>
            <a
              ...
              rel="noopener noreferrer"
            >
              <h3>Visit the 1st generation of my website</h3>
            </a>
